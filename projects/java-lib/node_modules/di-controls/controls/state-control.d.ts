import { OnChanges, Signal, SimpleChanges } from '@angular/core';
 ...
 * ```
 */
export declare abstract class DIStateControl<TModel> extends DIControl<TModel | boolean> implements OnChanges {
    protected readonly config?: DIStateControlConfig<boolean | TModel> | undefined;
    value: TModel | true;
    checked: Signal<boolean | null>;
    protected constructor(config?: DIStateControlConfig<boolean | TModel> | undefined);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<DIStateControl<any>, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<DIStateControl<any>, never, never, { "value": { "alias": "value"; "required": false; }; }, {}, never, never, false, never>;
}
